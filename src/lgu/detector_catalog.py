...
DETECTORS: tuple[DetectorSpec, ...] = (
    ...
    DetectorSpec(
        ...
        outcome="proof",
        threshold_args=(
            "low_context_revisit_count",
            "low_context_revisit_min_span_seconds",
        ),
        strong_proof=True,
    ),
    DetectorSpec(
    ...
    DetectorSpec(
        kind="low-context-fanout",
        scope="cross-ip",
        outcome="proof",
        threshold_args=(
            "low_context_fanout_window_seconds",
            "low_context_fanout_count",
            "low_context_fanout_unique_ips",
            "low_context_fanout_max_ip_share",
            "low_context_fanout_max_ip_requests",
            "low_context_fanout_min_ua_family_ratio",
        ),
        strong_proof=True,
    ),
    DetectorSpec(
