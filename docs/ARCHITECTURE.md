...
flowchart TD
    ...
    A --> D[Cross-IP payload campaign analysis]
    B --> E[ForcedProofs by IP]
    C --> E
    D --> E
```
...
flowchart LR
    ...
    C --> G[Mutation and repeated-pair findings]
    D --> H[Rapid UA switch finding]
    E --> I[Periodic poller finding]
    F --> J[Serial sweep finding]
    G --> K[ForcedProof list]
    H --> K
    I --> K
    J --> K
```
